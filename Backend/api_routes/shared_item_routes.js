...
import { get_list_of_shared_items, get_shared_entry_id_from_entity_id, create_a_shared_item_entry, delete_a_shared_item_entry, create_a_qr_code, decode_a_qr_code_and_get_data } from "../api_controllers/shared_item_controller.js";

const shared_items_router = express.Router();

shared_items_router.post('/get_list_of_shared_items', get_list_of_shared_items);
shared_items_router.post('/get_shared_entry_id_from_entity_id', get_shared_entry_id_from_entity_id);
